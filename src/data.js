...
export const agents = [
  { id: "product", name: "Product Lead", icon: "🚀", role: "Coordinates roadmap and project-room priorities", status: "active", tone: "orange", tasks: 3, platform: "Codex", capability: "Plan, critique, scope" },
  { id: "dev", name: "Dev", icon: "💻", role: "Builds UI, local state, bridge surfaces", status: "active", tone: "blue", tasks: 4, platform: "Codex", capability: "Propose edits, run checks" },
  { id: "safety", name: "Safety", icon: "🛡", role: "Reviews approvals, credentials, destructive actions", status: "active", tone: "green", tasks: 2, platform: "Policy", capability: "Approve, deny, block" },
  { id: "bridge", name: "Bridge", icon: "🔌", role: "Plans Tauri and Python worker integration", status: "review", tone: "violet", tasks: 2, platform: "Hermes-ready", capability: "Read-only native plan" },
  { id: "release", name: "Release", icon: "📦", role: "Maintains notes, risks, validation evidence", status: "idle", tone: "amber", tasks: 1, platform: "Codex", capability: "Docs and summaries" },
  { id: "support", name: "Support", icon: "💬", role: "Handles operator intake and ambiguous commands", status: "idle", tone: "slate", tasks: 1, platform: "Future", capability: "Triage and intake" }
];
export const approvals = [["Install provider integration dependency", "Add SDK package for a future model provider adapter.", "Bridge Engineer", "medium", "package.json", "npm install provider-sdk"], ["Remove stale prototype directory", "Delete an unused generated prototype folder after migration.", "Code Architect", "high", "prototype/archive", "recursive delete"], ["Change production model setting", "Point production profile to a different hosted model.", "Frontend Builder", "blocked", ".env.production", "edit production credential-adjacent config"]];
...
export const projectDocs = [
  { title: "Agent Guide", path: "/AGENTS.md", purpose: "Rules for safe AI-assisted work." },
  ...
  { title: "Implementation Log", path: "/IMPLEMENTATION_LOG.md", purpose: "What changed and how it was verified." },
...
export const agentPlatforms = [
  ...
  { id: "codex", name: "Codex", status: "available", role: "Primary supervised development partner", boundary: "Already in use; outputs remain review-required before release.", capabilities: ["implementation", "review", "documentation"], readiness: ["active", "human supervised", "validation checks"] }
];
export const projectRooms = [
  ...
  { id: "agent-integrations", name: "Agent Integrations", owner: "Bridge", accent: "green", goal: "Model Codex, Hermes, OpenHands, and AutoGen adapters safely." },
...
export const roomTasks = [
  ...
  { id: "task-7", room: "agent-integrations", status: "in-progress", title: "Expand adapter capability cards", summary: "Codex, Hermes, OpenHands, AutoGen with mode, boundary, readiness.", agent: "Bridge", tags: ["agents", "adapters"], due: "Today", priority: "high" },
  ...
  { id: "task-10", room: "release-readiness", status: "done", title: "Record install constraint", summary: "Package managers timed out; app is dependency-free for now.", agent: "Release", tags: ["risk", "notes"], due: "Done", priority: "low" }
];
